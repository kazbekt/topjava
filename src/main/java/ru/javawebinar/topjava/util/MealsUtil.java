...
public class MealsUtil {
    ...
    public static List<MealTo> convertTo(List<Meal> meals, Predicate<Meal> filter, int caloriesPerDay) {
    ...
    public static List<MealTo> createToByStreams(List<Meal> meals, int caloriesPerDay) {
        return convertTo(meals, meal -> true, caloriesPerDay);
    }
