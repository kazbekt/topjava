...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    @Autowired
    private ObjectProvider<JpaUtil> jpaUtilProvider;

    @Before
    public void setup() {
        cacheManager.getCache("users").clear();
        jpaUtilProvider.ifAvailable(JpaUtil::clear2ndLevelHibernateCache);
    }
    ...
    public void createWithException() {
        Assume.assumeFalse("Ignored for JDBC",
                Arrays.asList(environment.getActiveProfiles()).contains("jdbc"));
